...
class TestPalindromePermutation():
    ...
    def test_empty_string(self) -> None:
        ...
        assert palindrome_permutation(mt_str) == True

    def test_blank_string(self) -> None:
        blank_str = ' '

        assert palindrome_permutation(blank_str) == True

    def test_two_blank_spaces_string(self) -> None:
        two_blank_spaces_str = '  '

        assert palindrome_permutation(two_blank_spaces_str) == True
    ...
    def test_not_palindrome(self) -> None:
        ...
        assert palindrome_permutation(s) == False